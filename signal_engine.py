    ...
    def save_signals_to_json(self, filepath):
        ...
        for s in self.pending_signals:
            ...
            data.append({
                ...
                "close_order_expiration_ticks": s.close_order_expiration_ticks,
                "close_order_expiration_timestamp": s.close_order_expiration_timestamp,
                "close_order_expiration_timestamp_dt": s.close_order_expiration_timestamp_dt,
    ...
    def load_signals_from_json(self, filepath):
        ...
        for item in data:
            ...
            event = SignalEvent(
                ...
                close_order_expiration_ticks=item["close_order_expiration_ticks"],
                close_order_expiration_timestamp=item["close_order_expiration_timestamp"],
                close_order_expiration_timestamp_dt=item["close_order_expiration_timestamp_dt"],
